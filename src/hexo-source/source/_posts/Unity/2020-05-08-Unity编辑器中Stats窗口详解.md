---
title: "Unity Stats 窗口完全解析：游戏性能监控的第一道防线"
date: 2020/05/08
categories: [技术文章, Unity开发]
tags: [Unity, Stats, 性能监控, 渲染统计, FPS, DrawCall, 优化]
image: /images/unity-stats-window-complete-guide-banner.jpg
---

# 📊 Unity Stats 窗口完全解析：游戏性能监控的第一道防线
...
> - 不同平台的性能差异如何对比？
>
> **完全解析**！掌握 Unity 内置的性能监控工具！

渲染统计窗口游戏视野（Game View）右上角有一个Stats按钮。这个按钮是按下状态时，会显示一个半透明窗口，它显示对于优化性能很有用的实时渲染统计数据。根据目标平台不同，精确的统计数据也不同。
