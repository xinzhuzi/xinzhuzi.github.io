---
title: "Unity 自动化测试与性能分析：UPR + Airtest 企业级实践"
date: 2020/05/08
categories: [技术文章, Unity开发]
tags: [Unity, UPR, Airtest, 自动化测试, 性能分析, Jenkins, Python, ADB]
image: /images/unity-automated-testing-performance-banner.jpg
---

# 🤖 Unity 自动化测试与性能分析：UPR + Airtest 企业级实践

> 💡 **自动化测试的价值**：
> - 手动测试太累，覆盖不全？
> - 如何让游戏自己"玩"起来，自动测试？
> - 性能数据如何自动采集和分析？
> - UPR + Airtest + Jenkins，如何构建完整的自动化测试体系？
>
> **企业级实践**！手把手教你搭建 Unity 自动化测试与性能分析系统，让机器人 24 小时帮你测试！
...
- 4 Jenkins 基本操作,安装并且创建任务,得到可执行结果.(官网:[https://www.jenkins.io/](https://www.jenkins.io/))
- 5 shell 基础(基本学习:[https://www.runoob.com/linux/linux-shell.html](https://www.runoob.com/linux/linux-shell.html) ;  [https://www.bilibili.com/video/BV1bg4y1i7Zj](https://www.bilibili.com/video/BV1bg4y1i7Zj))
- 6 Python 基础(B 站上找个全套 Python 看完即可)
- 7 Unity 打包([https://docs.unity3d.com/Manual/CommandLineArguments.html](https://docs.unity3d.com/Manual/CommandLineArguments.html))
- 8 UPR 基础操作([https://upr.unity.cn/instructions](https://upr.unity.cn/instructions))
- 9 Airtest IDE 软件操作([http://airtest.netease.com/](http://airtest.netease.com/))
- 10 一定要 shell,Python,Unity,Jenkins,UPR,Airtest,adb 串联起来才可以搭建起来整个流程.

准备
- 1 安装 [Jenkins](https://www.jenkins.io/),具体的配置请查看教程: [https://www.jianshu.com/p/5ad61bb45b32](https://www.jianshu.com/p/5ad61bb45b32)
- 2 安装 Unity ,官网下载安装即可.
- 3 安装 Python ,安装 3.7 版本,如果安装了 Python3.8 也是可以做的.
- 4 安装 Airtest IDE ,直接下载即可,本教程中采取的是 AirtestIDE.app的使用,没有使用 Python 环境打造.
- 5 下载 UPR mac 版到电脑,放在工作文件夹中.请查看官网[https://upr.unity.cn/](https://upr.unity.cn/) 

工业化流程
1 创建一个 Jenkins 任务,选择自由构建,最终会执行一个脚本.以下代码为 shell 脚本里面的代码,最终会在 Jenkins 里面执行.
![Jenkins配置1](/2020/06/20/Unity/IndustrialAutomation/Unity%E5%90%8E%E5%B7%A5%E4%B8%9A%E5%8C%96%E6%B5%81%E7%A8%8B2/Jenkins%E9%85%8D%E7%BD%AE1.png)
![Jenkins配置2](/2020/06/20/Unity/IndustrialAutomation/Unity%E5%90%8E%E5%B7%A5%E4%B8%9A%E5%8C%96%E6%B5%81%E7%A8%8B2/Jenkins%E9%85%8D%E7%BD%AE2.png)

2 在 SVN 上面创建一个文件夹,用来存放当前教程中用到的工具以及代码
![SVN 目录](/2020/06/20/Unity/IndustrialAutomation/Unity%E5%90%8E%E5%B7%A5%E4%B8%9A%E5%8C%96%E6%B5%81%E7%A8%8B2/SVN%E7%9B%AE%E5%BD%95.png)

3:介绍从 shell 脚本Auto_Check_All.sh 运行到打包GetAndReport.py 的步骤.首先是 Unity 打包策略.也就是第一步,形成打包自动化,真正的 Jenkins 打包界面是需要很多参数形成的,此流程仅仅为了方便,因此做简化.需要注意的是,此打包方式一定是开发模式.(请移步官网 [https://docs.unity3d.com/Manual/CommandLineArguments.html](https://docs.unity3d.com/Manual/CommandLineArguments.html))
...
![性能检测.png](/2020/06/20/Unity/IndustrialAutomation/Unity%E5%90%8E%E5%B7%A5%E4%B8%9A%E5%8C%96%E6%B5%81%E7%A8%8B2/%E6%80%A7%E8%83%BD%E6%A3%80%E6%B5%8B.png)
![资源检测.png](/2020/06/20/Unity/IndustrialAutomation/Unity%E5%90%8E%E5%B7%A5%E4%B8%9A%E5%8C%96%E6%B5%81%E7%A8%8B2/%E8%B5%84%E6%BA%90%E6%A3%80%E6%B5%8B.png)
...
![最终@所有人.png](/2020/06/20/Unity/IndustrialAutomation/Unity%E5%90%8E%E5%B7%A5%E4%B8%9A%E5%8C%96%E6%B5%81%E7%A8%8B2/%E6%9C%80%E7%BB%88@%E6%89%80%E6%9C%89%E4%BA%BA.png)

- 12:资源与 AB 包检测,根据官网的 shell 写法,直接在 Jenkins 里面输出即可,处理二次数据与上面方式一样.

代码窥探![Auto_Check_All.png](/2020/06/20/Unity/IndustrialAutomation/Unity%E5%90%8E%E5%B7%A5%E4%B8%9A%E5%8C%96%E6%B5%81%E7%A8%8B2/Auto_Check_All.png)
![Auto_End_Game.png](/2020/06/20/Unity/IndustrialAutomation/Unity%E5%90%8E%E5%B7%A5%E4%B8%9A%E5%8C%96%E6%B5%81%E7%A8%8B2/Auto_End_Game.png)
![Get_Sessionid.png](/2020/06/20/Unity/IndustrialAutomation/Unity%E5%90%8E%E5%B7%A5%E4%B8%9A%E5%8C%96%E6%B5%81%E7%A8%8B2/Get_Sessionid.png)
![Report_All.png](/2020/06/20/Unity/IndustrialAutomation/Unity%E5%90%8E%E5%B7%A5%E4%B8%9A%E5%8C%96%E6%B5%81%E7%A8%8B2/Report_All.png)
...
3 本公司招人
![job.jpg](/2020/06/20/Unity/IndustrialAutomation/Unity%E5%90%8E%E5%B7%A5%E4%B8%9A%E5%8C%96%E6%B5%81%E7%A8%8B2/job.jpg)
